...
for lang in "en" "ru"
do
    jq -n '[ { "subvariant": "workstation", "category": "product", "name": "", "summary": "", "icon": "qrc:/logos/workstation", "screenshots": [], "description": "" }, { "subvariant": "server", "category": "product", "name": "", "summary": "", "icon": "qrc:/logos/server", "screenshots": [], "description": "" }, { "subvariant": "education", "category": "product", "name": "", "summary": "", "icon": "qrc:/logos/kde", "screenshots": [], "description": "" } ]' > metadata_$lang.json
done
