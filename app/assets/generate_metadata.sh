...
for lang in "en" "ru"
do
    jq -n '[ { "variant": "workstation", "name": "", "summary": "", "icon": "qrc:/logos/workstation", "screenshots": [], "description": "" }, { "variant": "server", "name": "", "summary": "", "icon": "qrc:/logos/server", "screenshots": [], "description": "" }, { "variant": "education", "name": "", "summary": "", "icon": "qrc:/logos/education", "screenshots": [], "description": "" } ]' > metadata_$lang.json
done
